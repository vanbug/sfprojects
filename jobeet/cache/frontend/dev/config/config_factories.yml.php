...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/var/www/sfprojects/jobeet/log/frontend_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/var/www/sfprojects/jobeet/cache/frontend/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/var/www/sfprojects/jobeet/apps/frontend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/var/www/sfprojects/jobeet/cache/frontend/dev/template',
  'lifetime' => 86400,
  'prefix' => '/var/www/sfprojects/jobeet/apps/frontend/template',
)));
